...
public class run {
    public static void main(String[] args) throws IOException {
        ...
        String query = "INSERT INTO Costomers (CustomerName, ContactName) VALUES ('Cardinal', 'Tom B.');";
        String query1 = "CREATE TABLE Costomers (CustomerName varchar(20), ContactNumber number(10));";
